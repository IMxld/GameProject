...
public class Entry11 : EntryVoid, IEntryInterface
{
    public string Name = "名人";//词条名
    public string Imformation = "结算时，基础票房收入增加10%";//词条说明
    ...
    {
        ChangeIncome(0.1f, _character.CurrentDrama);
    }
