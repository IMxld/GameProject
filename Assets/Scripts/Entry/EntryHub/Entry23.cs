...
public class Entry23 : EntryVoid, IEntryInterface
{
    public string Name = "心理学教父";//词条名
    public string Imformation = "所有演员损耗的疲劳值降低20%";//词条说明
    ...
    void IEntryInterface.AfterEffect(Character _character)//每一部剧结算时影响（收入、增长粉丝数）
    {
        ...
        {
            ChangeDecreaseStaminaSpeed(-0.2f, _item);
        }
    }
