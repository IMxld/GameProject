...
public class Entry06 : EntryVoid, IEntryInterface
{
    public string Name = "惊艳";//词条名
    public string Imformation = "完美出现时，额外增加的粉丝数增加10%";//词条说明
    ...
    {
        ChangePecfectFansRate(0.1f, _character.CurrentDrama);
    }
