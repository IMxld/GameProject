...
public class Entry05 : EntryVoid, IEntryInterface
{
    public string Name = "灵光一闪";//词条名
    public string Imformation = "完美出现几率增加5%";//词条说明
    ...
    {
        ChangePecfectChance(0.05f, _character.CurrentDrama);
    }
