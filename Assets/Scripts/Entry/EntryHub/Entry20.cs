...
public class Entry20 : EntryVoid, IEntryInterface
{
    public string Name = "明星";//词条名
    public string Imformation = "结算时，基础票房收入增加20%";//词条说明
    ...
    {
        ChangeIncome(0.2f, _character.CurrentDrama);
    }
