...
public class Entry24 : EntryVoid, IEntryInterface
{
    public string Name = "剧场魅影";//词条名
    public string Imformation = "完美出现几率增加20%";//词条说明
    ...
    {
        ChangePecfectChance(0.2f, _character.CurrentDrama);
    }
