...
public class Entry01 : EntryVoid, IEntryInterface
{
    public string Name = "小有名气";//词条名
    public string Imformation = "结算时，基础票房收入增加5%";//词条说明
    ...
    {
        ChangeIncome(0.05f, _character.CurrentDrama);
    }
