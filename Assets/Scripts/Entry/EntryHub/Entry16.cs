...
public class Entry16 : EntryVoid, IEntryInterface
{
    public string Name = "华丽";//词条名
    public string Imformation = "完美出现时，额外增加的粉丝数增加20%";//词条说明
    ...
    {
        ChangePecfectFansRate(0.2f, _character.CurrentDrama);
    }
