...
public class Entry03 : EntryVoid, IEntryInterface
{
    public string Name = "不倦";//词条名
    public string Imformation = "损耗的疲劳值降低10%";//词条说明
    ...
    {
        ChangeDecreaseStaminaSpeed(-0.1f, _character);
    }
