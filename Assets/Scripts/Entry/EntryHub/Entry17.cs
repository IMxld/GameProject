...
public class Entry17 : EntryVoid, IEntryInterface
{
    public string Name = "超越";//词条名
    public string Imformation = "完美出现时，额外增加的票房数增加20%";//词条说明
    ...
    {
        ChangePecfectIncomesRate(0.2f, _character.CurrentDrama);
    }
