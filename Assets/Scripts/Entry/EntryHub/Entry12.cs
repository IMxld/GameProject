...
public class Entry12 : EntryVoid, IEntryInterface
{
    public string Name = "梦中情人";//词条名
    public string Imformation = "结算时，基础粉丝收入增加10%";//词条说明
    ...
    {
        ChangeFans(0.1f, _character.CurrentDrama);
